      ...
      <div className="max-w-5xl mx-auto px-6 py-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex space-x-3">
              <button
                ...
                className="flex-1 bg-blue-500 hover:bg-blue-600 active:bg-blue-700 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200 shadow-sm hover:shadow-md text-[15px]"
              >
                {editingTodo ? '更新' : '追加'}
              </button>
            </div>
        ...
        {selectedTodo && (
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-sm border border-gray-200/60 p-6">
            ...
            <p className="text-gray-900 mb-4 text-[15px]">{selectedTodo.text}</p>
            <div className="flex space-x-3">
              <button
                onClick={handleEditClick}
                className="flex-1 bg-gray-100 hover:bg-gray-200 active:bg-gray-300 text-gray-700 font-medium py-2.5 px-4 rounded-xl transition-all duration-200 text-sm"
              >
                編集
              </button>
              <button
                onClick={handleDeleteClick}
                className="flex-1 bg-red-50 hover:bg-red-100 active:bg-red-200 text-red-600 font-medium py-2.5 px-4 rounded-xl transition-all duration-200 text-sm"
              >
                削除
              </button>
            </div>
